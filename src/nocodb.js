const STANDARD_FIELDS = [
  ...
  { name: "cid", type: "SingleLineText" },
  { name: "data_id", type: "SingleLineText" },
  { name: "maps_link", type: "URL" },
  ...
  { name: "all_emails", type: "LongText" },
  { name: "email_source", type: "SingleLineText" },
  { name: "contact_page_url", type: "URL" },
  { name: "social_links_json", type: "LongText" },
...
function buildRecord(job, lead, availableFields) {
  const record = {
    ...
    phone: lead.phone || "",
    email: lead.email || "",
    all_emails: Array.isArray(lead.emails) ? lead.emails.join(" | ") : "",
    email_source: lead.emailSource || "",
    contact_page_url: lead.contactPageUrl || "",
    social_links_json: JSON.stringify(lead.socialLinks || {}),
